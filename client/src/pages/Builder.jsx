...
const DraggableLayer = ({ id, x, y, children, onUpdate, onDelete, isSelected, onSelect, onDragStart, onDragEnd }) => {
...
const Builder = () => {
    ...
    const handleDownloadPDF = async () => {
        ...
        setSelectedId(null); // Clear selection for export
    ...
    return (
        <div className="flex bg-gray-100 dark:bg-gray-950 h-[calc(100vh-64px)] w-full overflow-hidden transition-colors duration-500 font-inter">
                ...
                <div className="p-6 overflow-y-auto flex-1 custom-scrollbar space-y-8">
                    {sidebarTab === 'design' && (
                        <>
                            <div className="space-y-4">
                                <h4 className="flex items-center gap-2 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]"><Palette className="w-3 h-3" /> Branding Colors</h4>
                            ...
                            <div className="space-y-4">
                                <h4 className="flex items-center gap-2 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]"><Type className="w-3 h-3" /> Typography</h4>
                    ...
                    {sidebarTab === 'elements' && (
                        <>
                            <div className="space-y-5">
                                <h4 className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Upload Media</h4>
                            ...
                            <div className="space-y-5">
                                <h4 className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Quick Icons</h4>
                    ...
                    {sidebarTab === 'sections' && (
                        <div className="space-y-6">
                            <h4 className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Add Content Blocks</h4>
            ...
            {/* Main Canvas Area */}
            <div className="flex-1 overflow-y-auto p-12 custom-scrollbar bg-gray-100 dark:bg-gray-950 flex justify-center items-start" onContextMenu={handleContextMenu}>
                <div
                    ref={paperRef}
