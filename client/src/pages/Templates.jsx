    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <header className="mb-10 text-center">
                <h2 className="text-4xl font-black text-gray-900 dark:text-white mb-2 tracking-tight">Pick your canvas</h2>
                <p className="text-gray-500 dark:text-gray-400 text-lg">Choose a layout and start building with our interactive editor.</p>
            </header>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
                {templates.map((tpl) => (
                    <div key={tpl.id} className="group bg-white dark:bg-gray-900 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                        <div className="h-80 bg-gray-50 dark:bg-gray-800/50 relative flex flex-col p-8 overflow-hidden">
                        ...
                        <div className="p-6">
                            <div className="flex justify-between items-center mb-3">
                                ...
                                <div className="p-1 bg-green-50 dark:bg-green-900/30 rounded-full opacity-0 group-hover:opacity-100 transition duration-500">
                                    <CheckCircle2 className="w-4 h-4 text-green-500" />
                                </div>
                            </div>
                            <h3 className="text-xl font-black text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition duration-300">{tpl.name}</h3>
                            <p className="text-sm text-gray-400 dark:text-gray-500 mt-2 leading-relaxed">{tpl.desc}</p>
                        </div>
                    </div>
                ))}
            </div>
